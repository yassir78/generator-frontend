...
export class RoleMenuComponent implements OnInit {
    ...
    openAffecterDialog(role: RoleConfig) {
        const list = this.selectedRole.menuRoles;
        list.length ? this.serviceMenu.affectedMenus = list : this.serviceMenu.affectedMenus = [];
        this.selectedRole.menuRoles.map(mr=>{ this.menusToBeAffected=this.menusToBeAffected.filter(m=> m.libelle != mr.menu.libelle)})
